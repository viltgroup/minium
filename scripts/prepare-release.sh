...
chronic mvn --batch-mode release:prepare release:perform -Dtag=$TAG -DreleaseVersion=$RELEASE_VERSION  -DperformRelease="true" $MAVEN_EXTRA_ARGS $MAVEN_RELEASE_EXTRA_ARGS
