...
chronic mvn --batch-mode release:prepare -Dtag=$TAG -DreleaseVersion=$RELEASE_VERSION -DdevelopmentVersion=$DEV_VERSION -DperformRelease="true" $MAVEN_EXTRA_ARGS $MAVEN_RELEASE_EXTRA_ARGS
