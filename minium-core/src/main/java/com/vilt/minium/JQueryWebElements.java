...
public interface JQueryWebElements<T extends WebElements> extends WebElements, WebElementsFinder<T> {
	...
	/**
	 * <!-- begin-minium-doc http://api.jquery.com/eq/#eq-index -->
	 * Reduce the set of matched elements to the one at the specified index.
	 * 
	 * @param index An integer indicating the 0-based position of the element. 
	 * @return result of jQuery .eq() method
	 * @see <a href="http://api.jquery.com/eq/#eq-index">jQuery .eq() method</a>
	 * <!-- end-minium-doc -->
	 */
	 ...
	 * 
	 * @param selector A string containing a selector expression to match elements against.
	 * @return result of jQuery .find() method
	 * @see <a href="http://api.jquery.com/find/#find-selector">jQuery .find() method</a>
	 * <!-- end-minium-doc -->
	 */
	@Override
	 ...
	 * @param elems A jQuery object to match elements against.
	 * @return result of jQuery .find() method
	 * @see <a href="http://api.jquery.com/find/#find-jQuery-object">jQuery .find() method</a>
	 * <!-- end-minium-doc -->
	 */
	@Override
	 ...
	 * 
	 * @return result of jQuery .first() method
	 * @see <a href="http://api.jquery.com/first/">jQuery .first() method</a>
	 * <!-- end-minium-doc -->
	 */
	public T first();
	 ...
	 * 
	 * @return result of jQuery .last() method
	 * @see <a href="http://api.jquery.com/last/">jQuery .last() method</a>
	 * <!-- end-minium-doc -->
	 */
	public T last();
	 ...
	 * 
	 * @return result of jQuery .size() method
	 * @see <a href="http://api.jquery.com/size/#size">jQuery .size() method</a>
	 * <!-- end-minium-doc -->
	 */
	public int size();
