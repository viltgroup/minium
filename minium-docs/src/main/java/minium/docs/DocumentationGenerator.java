...
public class DocumentationGenerator {
    ...
    public void generateAllDocs() throws IOException {
        generateDocs("api/Elements.md", "Elements",
        ...
        generateDocs("api/Interactions.md", "Interactions", Interactable.class);
        generateDocs("api/WaitInteractions.md", "Wait Interactions", WaitInteractable.class);
        generateDocs("api/DebugInteractions.md", "Debug Interactions", DebugInteractable.class);
        generateDocs("api/InteractionListeners.md", "Interaction Listeners", InteractionListeners.class);
    }
    ...
    protected Object args(Method method) {
        Iterable<String> argTypeNames = FluentIterable.from(ImmutableList.copyOf(method.getParameterTypes()))
    ...
    public static void main(String[] args) throws IOException {
        new DocumentationGenerator("target/generated").generateAllDocs();
    }
}
