 ...
 * @author rui.figueira
 */
public class MiniumScreenRecorder extends ScreenRecorder {
	
	private File miniumMovieFile;

	public MiniumScreenRecorder() throws HeadlessException, IOException, AWTException {
		this(null);
	}
	
	public void start(File file) throws IOException {
		miniumMovieFile = file;
		super.start();
	}
	...
	protected File createMovieFile(Format fileFormat) throws IOException {
		if (miniumMovieFile == null) {
			return super.createMovieFile(fileFormat);			
		}
		return miniumMovieFile;
	}
	
	public MiniumScreenRecorder(WebElementsDriver<?> wd) throws HeadlessException, IOException, AWTException {
		super(
				GraphicsEnvironment
