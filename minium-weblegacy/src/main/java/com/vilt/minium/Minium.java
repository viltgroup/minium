...
public class Minium {
     ...
     * @return the t
     */
    public static DefaultWebElements $(DefaultWebElementsDriver wd) {
     ...
     * @return the t
     */
    public static DefaultWebElements $(DefaultWebElementsDriver wd, String selector) {
     ...
     */
    public static WebElements $(WebDriver wd) {
